...
<body>
	...
	<div id="outer">
		...
		<div align="center" style="margin-bottom: 10px">
			<a href="driver_ReqOrder.jsp" style="text-decoration: none; padding-left: 40px;">
				<span style="font-size: 30px">확인</span>	
			</a>
			<a href="/semi/views/request/popup/pop_Driver_Req.jsp" style="text-decoration: none; padding-left: 40px;">
				<span style="font-size: 30px">견적 매칭 신청</span>	
			</a>
