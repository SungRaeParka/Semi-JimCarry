    <%@ page language="java" import="java.util.*, java.security.*, java.io.*, java.net.*, com.google.gson.Gson, org.json.simple.JSONObject" %>
    ...
    if(action.equals("go")) {
        ...
        String user_id = base64Encode("ksjp1117"); // SMS아이디
        String secure = base64Encode("90608f1b049410403bf2ba5d0c55fda6");//인증키
