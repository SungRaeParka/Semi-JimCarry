...
<body>
	...
	<div class="container" style="margin-top: 70px;">
		...
		<p>
			...
			</select> <input type="button" value="글쓰기"
		...
		<table align="center" border="1" summary="게시판 상세조회">
			...
			<tbody>
				...
				<tr>
					<td colspan="2"><img src="../board/images/driver1.png"
						width="300px" height="300px" /> 빠르게 옮기는 것도 좋지만, 그보다 중요한 건 안전이에요.
						우선 첫째로 사람이 다치지 않아야 하고, 둘째로 물건이 다치지 않아야 해요. 하루는 고객 이사를 도와주러 온 남자분이
						힘도 넘치고 의욕도 넘쳐서 여기저기 엄청 뛰어다니는 거예요. 저러다 다칠까 봐 걱정되더라구요. 아니나 다를까, 지하
						주차장에 대있던 트럭에 폴짝 뛰어 올라서더니 ‘억!’ 하는 소리를 내는거에요. 주차장 천장에 머리가 부딪힌 거죠.
						남자분이 괜찮다고 얘기하는데 머리에서 피가 주르륵 흐르는 거에요. 놀라서 마무리는 혼자 할 테니 얼른 짐내려두고 얼른
						병원 갔다 오라고 했던 일이 있었어요. 기분 좋은 이삿날 사람이든 물건이든 다치면 마음이 아프잖아요. 그래서 항상
						이사하러 갈 때마다 고객한테 신신당부해요. 천천히 하더라도 안전하고 기분 좋게 이사를 마치자고.</td>
				</tr>
			</tbody>
		</table>
	</div>
	...
	<p>
		...
		<input type="button" value="수정"
			onclick="goUrl('boardModifyForm.jsp');" /> <input type="button"
			value="삭제" onclick="goUrl('boardProcess.jsp');" />
	</p>
</body>
</html>