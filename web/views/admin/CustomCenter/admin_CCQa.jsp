...
<body>
	...
	<div class="container" style="margin-top: 70px;">
		...
		<ul class="nav nav-tabs">
			...
			<li class="active"><a data-toggle="tab" href="#menu2">Q&A</a></li>
		</ul>
						...
						<tr>
							<th colspan="5">
								<form action="">
									...
									<input type="radio" name="sort" id="결제/진행" value="결제/진행"> <label for="결제/진행">&nbsp;결제/진행&nbsp;&nbsp;</label>
									<input type="radio" name="sort" id="변경/취소" value="변경/취소"> <label for="변경/취소">&nbsp;변경/취소&nbsp;&nbsp;</label>
									<input type="radio" name="sort" id="기타문의" value="기타문의"> <label for="기타문의">&nbsp;기타문의&nbsp;&nbsp;</label>
								</form>
