				...
				<div class="outer">
					...
					<div class="tableArea" align="center">
						<table border="1">
							...
							<tr>
								<td colspan="4" style="text-align: center">내&nbsp;&nbsp;&nbsp;&nbsp;용</td>

							</tr>
							<tr>
								<td colspan="4"><textarea name="content" id="" cols="60"
										rows="15" style="resize: none;" readonly><%-- <%=n.getnContent()%> --%></textarea>
								</td>
							</tr>
						</table>
						<br />
						<div align="center">
							<button
								onclick="location.href='<%=request.getContextPath()%>/selectList.no'">메뉴로
								돌아가기</button>
							<%-- <% if(loginUser != null && loginUser.getUserId().equals("admin")){ %> --%>
							<button
								onclick="location.href='<%=request.getContextPath()%>/selectNotice.no?num=<%-- <%=n.getNno()%> --%>'">수정하기</button>
