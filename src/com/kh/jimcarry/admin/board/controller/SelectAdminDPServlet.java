...
@WebServlet("/selectAdmin.dp")
public class SelectAdminDPServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("selectAdminDPServlet 들어옴");
		...
		if(dpList != null) {
			page = "views/admin/board/admin_Board.jsp";
