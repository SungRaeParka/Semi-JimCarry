...
/**
 * Servlet implementation class boardSerachDriver
 */
@WebServlet("/boardSerachDriver")
public class boardSerachDriver extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public boardSerachDriver() {
        super();
	...
	//	String word;
		...
		if(list !=null) {
			page = "views/board/user_ReviewDriverSearchArea.jsp";
